...
### Metric Markdown
```bath
usage: metric-markdown [-h] [-d] [-e EMAIL] [-f PATH] [-t APIKEY] [-v]

Generate Markdown from plugin.json manifest
...
optional arguments:
  ...
  -e EMAIL, --email EMAIL
                        e-mail uses to create the account
  -f PATH, --file PATH  Path to plugin.json manifest. Defaults to plugin.json
  -t APIKEY, --api-key APIKEY
  -v                    verbose mode
```
